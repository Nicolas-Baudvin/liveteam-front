...
const ListItem = styled.li`
        ...
        &:hover {
            ...
            background-color: ${props => props.connexion ? "#1FA482" : "rgba(35,188,149, .1)"};
            transform: ${props => props.connexion && "translate(0,-2px)"}
        }

        &:focus {
            transform: ${props => props.connexion && "translate(0,2px)"};
            box-shadow: ${props => props.connexion ? "0 2px 5px rgba(0, 0, 0, .5)" : "none"};
        }
    `;
